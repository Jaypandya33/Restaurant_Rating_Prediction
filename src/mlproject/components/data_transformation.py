...
from src.mlproject.utils.utils import save_object,handle_categorical_columns,handle_rate_column
    ...
    def get_data_transformation(self):
        ...
        try:
            ...
            cat_pipeline=Pipeline(
                ...
                ('onehotencoder', OneHotEncoder(sparse_output=False,handle_unknown='ignore')),  #created object for cat_encoding
